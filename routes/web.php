...
Route::get('llanta', [LlantaController::class, 'index'])->name('llanta_index');
...
//pedidos
Route::get('pedidosweb', [PedidosWebController::class, 'index'])->name('pedidosweb_index');
...
//ventas
Route::get('ventasweb', [VentasWebController::class, 'index'])->name('ventasweb_index');

//cancelados
Route::get('canceladosweb', [CanceladosWebController::class, 'index'])->name('canceladosweb_index');

//contacto
Route::get('contactoindex', [ContactoController::class, 'index'])->name('contacto_index');
...
//dimension
Route::get('dimension', [DimensionController::class, 'index'])->name('dimension_index');
