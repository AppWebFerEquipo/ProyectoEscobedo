            ...
            <div class="col-md-8 col-lg-8 pb-4">
                ...
                <div class="col-lg-4">
                  <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                    ...
                    <div class="service-contents">
                      <p>Fracc. Pedregales, calle 62 691 x 45, y 45A, Cd Caucel, 97314 Caucel, Yuc.</p>
              ...
              <form action="{{route('guardarcontacto')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-5">
                  ...
                  <textarea class="form-control" id="message" name="message" maxlength="1000" cols="30" rows="5"></textarea>
                </div>
